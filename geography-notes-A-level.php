...
<body>
    <nav class="navigation">
        ...
        <div class="dropdown_menu">
            <ul type="none">
                ...
                <li><a href="council.html">Admin</a></li>
        </div>
    </nav>
    <div class="sub_menu">
        <ul>
            <li><a href="council.html"><b>Admin</b></a></li>
    ...
    <script>
        ...
        multimenu.onclick = function(){
          ...
          <div class="options">
               <h1 style="color: red; text-align: center; font-size: 40pt; font-family: Georgia, 'Times New Roman', Times, serif;">
                    Choose the category you want:
               </h1>
               <div class="inorganic">
                    <div class="notes">
                         <a href="media\documents\adv-book-physical-geography.pdf" target="_blank"><b>Physical Geography</b></a>
                    </div>
               </div>
               <div class="general">
                    <div class="notes">
                         <a href="media\documents\adv-book-practical-geography.pdf" target="_blank"><b>Practical Geography</b></a>
                    </div>
               </div><div class="physical">
                    <div class="notes">
                         <a href="media\documents\adv-book-human-geography.pdf" target="_blank"><b>Human & Economic Geography</b></a>
                    </div>
               </div>
          </div>
          <div class="footer">
